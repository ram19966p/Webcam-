...
//         
//         Mp4  Video =  new  Mp4();
//         Video.startMp4Recording();
//         
//     }
//    
//     private void startMp4Recording() throws InterruptedException{
//         File saveFile =  new File("saved.mp4");
//         // Initialize media write 
...
//             IConverter converter  = ConverterFactory.createConverter(image,IPixelFormat.Type.YUVA420P);
...
//         }
//        writer.close();
//        System.out.println("Video  Recorded to File"+ saveFile.getAbsolutePath());
//     }
